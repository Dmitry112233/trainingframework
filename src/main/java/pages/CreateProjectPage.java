...
public class CreateProjectPage extends Page {
    ...
    public String getProjectName() {
        String projectName = driver.findElement(NAME_FIELD).getAttribute("value");
        log.info("Get project name: " + projectName);
        return projectName;
    }

    public String getProjectDescription() {
        String projectDescription = driver.findElement(DESCRIPTION_FIELD).getAttribute("value");
        System.out.println("THIS IS FUCKING DESC:  " + projectDescription);
        log.info("Get project description: " + projectDescription);
        return projectDescription;
    }

    public String getFirstProjectDomain() {
        String projectDomain = getDomainFields().get(0).getAttribute("value");
